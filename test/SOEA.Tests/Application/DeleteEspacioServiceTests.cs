...
namespace SOEA.Tests.Application
{
    ...
    /// Espacio→Grupo.RequisitosEspacio. No revisa Sesiones a propósito: son datos generados y
    ...
    public class DeleteEspacioServiceTests
    {
        ...
        {
            var service = new EspacioService(new FakeEspacioRepo(), new FakeGrupoRepo());
