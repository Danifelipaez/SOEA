...
| AC-05 | Ningún espacio físico excede su capacidad | Verificar `num_estudiantes ≤ espacio.capacidad` para sesiones presenciales |
...
| AC-P02 | El control de acceso basado en roles está verificado para los cuatro roles (Admin, Coordinador, Docente, Estudiante) |
