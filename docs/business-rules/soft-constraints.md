...
| SC-02 | Los horarios del grupo deben ser compactos (minimizar huecos inactivos para los estudiantes) | 3 |
| SC-03 | Las sesiones del mismo grupo en el mismo día no deberían dejar más de 1 hora de hueco | 2 |
| SC-04 | Evitar, cuando sea posible, programar la primera sesión de un grupo antes de las 07:00 o la última después de las 19:00 | 2 |
| SC-05 | Asignar al mismo grupo el mismo salón para la misma asignatura en distintas semanas (estabilidad de aula) | 2 |
...
| SC-07 | Minimizar el número de espacios diferentes usados por el mismo grupo en un mismo día | 1 |
| SC-08 | Preferir programar asignaturas relacionadas (mismo programa, mismo grupo) en espacios de tiempo adyacentes | 1 |
...
- Un grupo con sesiones de 07:00–09:00 y 13:00–15:00 sin clase en medio incurre en una
...
- ¿SC-04 (horarios preferidos) es configurable por grupo o a nivel institucional?
